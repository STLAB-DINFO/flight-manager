...
//			FieldUtils.writeField(flightController, "flightDao", flightDao, true);
//			FieldUtils.writeField(flightController, "airportDao", airportDao, true);
...
//		assertTrue(flightController.returnInsertFlightPage().contains("add-flights"));
//	}
//	
//	@Test
...
//		
//		assertNull(flightController.getSourceAirportId());
//		assertNull(flightController.getDestinationAirportId());
//		
//		try {
//			FieldUtils.writeField(flightController, "airports", airports, true);
//		} catch (IllegalAccessException e) {
//			throw new InitializationError(e);
//		}
//		
//		//insertFlightController.reset();
//		
//		assertEquals(airports.get(0).getId(), flightController.getSourceAirportId());
//		assertEquals(airports.get(0).getId(), flightController.getDestinationAirportId());
//	}
//	
//	@Test
//	public void testGetFlight() {
//		assertEquals(0, flightController.getFlight().getReservedSeats());
//	}
//	
//	@Test
...
//		
//		assertEquals(airports, flightController.getAirports());
//	}
//	
//	@Test
//	public void testGetFlights() throws InitializationError {
//		assertTrue(flightController.getFlights().isEmpty());
//		
//		try {
//			FieldUtils.writeField(flightController, "flights", flights, true);
//		} catch (IllegalAccessException e) {
//			throw new InitializationError(e);
//		}
//		
//		assertEquals(flights, flightController.getFlights());
//	}
//	
//	@Test
...
//		/*-----------------------------------------------if--------------------------------------------------------*/
//		try {
//			FieldUtils.writeField(flightController, "sourceAirportId", Long.valueOf(0), true);
//			FieldUtils.writeField(flightController, "destinationAirportId", Long.valueOf(0), true);
//			FieldUtils.writeField(flightController, "fromDate", date, true);
//		} catch (IllegalAccessException e) {
//			throw new InitializationError(e);
//		}
//		String result = flightController.searchFlights();
//		assertTrue(result.contains("show-flights"));
//		assertTrue(flightController.getError().equals(""));
//		
//		try {
//			FieldUtils.writeField(flightController, "fromDate", dateAfterFiveMinutes, true);
//		} catch (IllegalAccessException e) {
//			throw new InitializationError(e);
//		}
//		result = flightController.searchFlights();
//		assertTrue(result.contains("show-flights"));
//		assertTrue(flightController.getError().contains("No available flights"));
//		/*-------------------------------------------else if-------------------------------------------------------*/
//		try {
//			FieldUtils.writeField(flightController, "fromDate", date, true);
//			FieldUtils.writeField(flightController, "sourceAirportId", Long.valueOf(0), true);
//			FieldUtils.writeField(flightController, "destinationAirportId", Long.valueOf(20), true);
//		} catch (IllegalAccessException e) {
//			throw new InitializationError(e);
//		}
//		result = flightController.searchFlights();
...
//		try {
//			FieldUtils.writeField(flightController, "sourceAirportId", Long.valueOf(0), true);
//			FieldUtils.writeField(flightController, "destinationAirportId", Long.valueOf(30), true);
//		} catch (IllegalAccessException e) {
//			throw new InitializationError(e);
//		}
//		result = flightController.searchFlights();
...
//		/*-------------------------------------------else if-------------------------------------------------------*/
//		try {
//			FieldUtils.writeField(flightController, "sourceAirportId", Long.valueOf(10), true);
//			FieldUtils.writeField(flightController, "destinationAirportId", Long.valueOf(0), true);
//		} catch (IllegalAccessException e) {
//			throw new InitializationError(e);
//		}
...
//		
//		try {
//			FieldUtils.writeField(flightController, "sourceAirportId", Long.valueOf(30), true);
//			FieldUtils.writeField(flightController, "destinationAirportId", Long.valueOf(0), true);
//		} catch (IllegalAccessException e) {
//			throw new InitializationError(e);
//		}
...
//	
//	/*
//	 * @Test public void testSaveFlight() throws InitializationError {
//	 * when(airportDao.findById( Long.valueOf(10) )).thenReturn(sourceAirport);
//	 * when(airportDao.findById( Long.valueOf(20) )).thenReturn(destinationAirport);
//	 * when(airportDao.findById( Long.valueOf(30) )).thenReturn(anotherAirport);
//	 * 
//	 * try { FieldUtils.writeField(insertFlightController, "sourceAirportType",
//	 * "existing", true); FieldUtils.writeField(insertFlightController,
//	 * "destinationAirportType", "existing", true);
//	 * FieldUtils.writeField(insertFlightController, "sourceAirportId",
//	 * Long.valueOf(10), true); FieldUtils.writeField(insertFlightController,
//	 * "destinationAirportId", Long.valueOf(20), true);
//	 * FieldUtils.writeField(insertFlightController, "flight", flight1, true);
//	 * FieldUtils.writeField(insertFlightController, "repeats", Integer.valueOf(5),
//	 * true); } catch (IllegalAccessException e) { throw new InitializationError(e);
//	 * } String result = insertFlightController.saveFlight();
//	 * assertTrue(result.contains("add-flights-details"));
//	 * assertTrue(insertFlightController.getError().equals("")); verify(flightDao,
//	 * times(1)).save(flight1);
//	 * 
//	 * //Source airport is new but it already exists List<String> airportNames = new
//	 * ArrayList<String>(); airportNames.add(sourceAirport.getCityName());
//	 * airportNames.add(destinationAirport.getCityName());
//	 * 
//	 * when(airportDao.getAllAirportsNames()).thenReturn(airportNames);
//	 * 
//	 * try { FieldUtils.writeField(insertFlightController, "sourceAirportType",
//	 * "new", true); FieldUtils.writeField(insertFlightController,
//	 * "sourceAirportNew", sourceAirport, true); } catch (IllegalAccessException e)
//	 * { throw new InitializationError(e); }
//	 * 
...
//	 * 
//	 * //Source airport is new but it doesn't exists try {
//	 * FieldUtils.writeField(insertFlightController, "sourceAirportType", "new",
//	 * true); FieldUtils.writeField(insertFlightController, "sourceAirportNew",
//	 * anotherAirport, true); } catch (IllegalAccessException e) { throw new
//	 * InitializationError(e); }
//	 * 
//	 * result = insertFlightController.saveFlight();
//	 * assertTrue(insertFlightController.getError().equals(""));
//	 * assertTrue(result.contains("add-flights-details")); verify(airportDao,
//	 * times(1)).save(anotherAirport);
//	 * 
//	 * //Destination airport is new but it already exists try {
//	 * FieldUtils.writeField(insertFlightController, "destinationAirportType",
//	 * "new", true); FieldUtils.writeField(insertFlightController,
//	 * "destinationAirportNew", destinationAirport, true); } catch
//	 * (IllegalAccessException e) { throw new InitializationError(e); }
//	 * 
//	 * result = insertFlightController.saveFlight();
//	 * assertTrue(insertFlightController.getError().contains("airport already exist"
//	 * )); assertTrue(result.equals("insert-flight"));
...
//	 * FieldUtils.writeField(insertFlightController, "destinationAirportType",
//	 * "new", true); FieldUtils.writeField(insertFlightController,
//	 * "destinationAirportNew", anotherOneAirport, true); } catch
//	 * (IllegalAccessException e) { throw new InitializationError(e); }
//	 * 
//	 * result = insertFlightController.saveFlight();
//	 * assertTrue(insertFlightController.getError().equals(""));
//	 * assertTrue(result.contains("add-flights-details")); verify(airportDao,
//	 * times(1)).save(anotherOneAirport); }
//	 */
//	
//	@Test
...
//		
//		assertTrue(flightController.deleteFlight("10").contains("delete-flight-success"));
//		
...
//		assertTrue(flightController.backToInsertFlight().contains("add-flights"));
//		assertTrue(flightController.getError().equals(""));
//	}
//	
//	@Test
//	public void testShowFlights() {
//		assertTrue(flightController.showFlights().contains("show-flights"));
//		assertTrue(flightController.getError().equals(""));
//	}
//}
